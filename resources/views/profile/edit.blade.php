<x-app-layout>
    ...
    <form action="" method="POST" class="max-w-sm mx-auto p-8 rounded-xl bg-indigo-500 flex flex-col gap-6">
        {{-- Name --}}
        <div>
            ...
            <input type="text" id="user-name" class="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ $user->name }}">
            </div>
        </div>
        {{-- Email --}}
        <div>
        ...
        <div>
            ...
            <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="user-icon" type="file">
        </div>
        {{-- Submit Button --}}
